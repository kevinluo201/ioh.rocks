...
Rails.application.config.assets.precompile += %w( live-chart.png )
Rails.application.config.assets.precompile += %w( success-banner.png )
Rails.application.config.assets.precompile += %w( success-agenda.png )
Rails.application.config.assets.precompile += %w( agenda-legend.png )
Rails.application.config.assets.precompile += %w( over-banner.png )
